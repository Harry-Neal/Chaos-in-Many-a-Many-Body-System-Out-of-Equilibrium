...
int main(){ 
ifstream File1("tau.txt");
string tau_txt;
getline (File1, tau_txt);
tau = std::stod(tau_txt);
T=1000*tau;
trel=25*tau;

ifstream File2("dj.txt");
string dj_txt;
getline (File2, dj_txt);
Jvar = std::stod(dj_txt);
